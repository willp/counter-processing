...
# (60, 2.1428571428571428),
# (120, 2.8571428571428572),
# (180, 0.5),
# (240, 6.1363636363636358),
# (300, 1.2747474747474747),
# (360, 1.1757575757575758),
# (420, 1.2108057317359644),
# (480, 1.386046511627907),
# (540, 1.386046511627907),
# (600, 1.386046511627907),
# (660, 1.386046511627907),
# (720, 1.386046511627907),
# (780, 1.386046511627907),
# (840, 1.386046511627907)]
...
print "Mem usage BEFORE making a zillion counters:\n";
show_mem();
my $x=0;
my $max = 20;
while ($x++ < $max) {
  my $wrap_val = 2**32 * 8;
    ...
    $c->new_count ( 300, $wrap_val / 2 );
    $c->new_count ( 600, 0 );
    #if ($x % ($max/20) == 0) { print "  building (x=$x) "; show_mem(); }
}
print "Stats:\n";
foreach my $stat_k (sort keys %{ $cp->{'stats'} }) {
  printf ("   %-35s = %15.1f\n", $stat_k, $cp->{'stats'}->{$stat_k});
}
print "Mem usage AFTER:\n";
show_mem();
#print "Persistence:\n";
